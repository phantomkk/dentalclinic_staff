...
//            if(position == calendar.get(Calendar.DAY_OF_MONTH)+7){
//                holder.llCell.setBackgroundColor(context.getResources().getColor(R.color.color_blue_grey_100));
//            }
            int toDay = (position - (7 + firstDay - 2));
//            if(toDay == tDay+1 && month == calendar.get(Calendar.MONTH)){
//                holder.llCell.setBackgroundColor(context.getResources().getColor(R.color.color_blue_grey_100));
//            }
